...
function buildBrief({ prompt, term, location, role, industry, tech }) {
...
export default {
  ...
  async *fetch({ term, location, limit = 4, pipeline = "sell", prompt, role, industry, tech, model }) {
    ...
    const brief = buildBrief({ prompt, term, location, role, industry, tech });
